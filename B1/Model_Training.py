...
x_train = pickle.load(open(r"../Datasets/B1_dataset/x_train.pickle","rb"))
x_val = pickle.load(open(r"../Datasets/B1_dataset/x_val.pickle","rb"))
y_train = pickle.load(open(r"../Datasets/B1_dataset/y_train.pickle", "rb"))
y_val = pickle.load(open(r"../Datasets/B1_dataset/y_val.pickle", "rb"))

# this is for loop run all 27 combinations of layer choices
# each combination of layer choice is ran for 20 epochs
# train on training set and validate on validation set which are all load from B1_dataset folder pickle file
...
for dense_layer in dense_layers:
    for layer_size in layer_sizes:
        for conv_layer in conv_layers:
            ...
            tensorboard = TensorBoard(log_dir="..\Datasets\B1_dataset\logs\{}".format(NAME))
