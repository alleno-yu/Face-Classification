...
def B1_data_preprocessing(IMG_SIZE, img_path, label_path):
    training_data = []
...
if __name__ == "__main__":
    ...
    print(B1_x_train.shape)
    pickle_out = open("../Datasets/B1_dataset/x_train.pickle", "wb")
    pickle.dump(B1_x_train, pickle_out)
    pickle_out.close()

    print(B1_x_val.shape)
    pickle_out = open("../Datasets/B1_dataset/x_val.pickle", "wb")
    pickle.dump(B1_x_val, pickle_out)
    pickle_out.close()

    print(B1_y_train.shape)
    pickle_out = open("../Datasets/B1_dataset/y_train.pickle", "wb")
    pickle.dump(B1_y_train, pickle_out)
    pickle_out.close()

    print(B1_y_val.shape)
    pickle_out = open("../Datasets/B1_dataset/y_val.pickle", "wb")
    pickle.dump(B1_y_val, pickle_out)
    pickle_out.close()